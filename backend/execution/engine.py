...
def start_research(run: ResearchRun) -> ResearchRun:
    ...
    return ResearchRun(run.run_id, run.contract, run.plan, "running", run.observations, run.claims, run.verified_claims, datetime.now(timezone.utc), run.completed_at)
