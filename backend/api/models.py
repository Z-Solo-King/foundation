...
# These are parser/admission safety ceilings, not user-adjustable resource budgets.
...
class ChatRequest:
    ...
    def validate(self) -> None:
        ...
        for turn in self.history:
            ...
            # `system` is reserved for trusted runtime context and can never be
            # supplied by a public caller.
