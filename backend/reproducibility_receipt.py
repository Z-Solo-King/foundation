...
class ReproducibilityReceipt:
    ...
    def validate(self) -> None:
        ...
        required = (self.repository, self.revision, self.workflow_run_id, self.suite_version, self.configuration, self.model_provider_mode, self.fixture_id, self.fixture_version, self.executed_at, self.runtime_class)
