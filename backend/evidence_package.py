...
class EvidencePackage:
    ...
    def payload(self) -> dict[str, Any]:
        return {"schema": self.schema, "package_id": self.package_id, "research_run_id": self.research_run_id, "source_versions": sorted(set(self.source_versions)), "evidence_spans": sorted(set(self.evidence_spans)), "claims": self.claims, "synthesis": self.synthesis, "artifact_digest": self.artifact_digest, "signer": self.signer}
