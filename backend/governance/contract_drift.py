...
def catalog_from_capabilities(
    ...
    *,
    ...
    catalog = ContractCatalog(
        ...
        promotion_authority=bool(capabilities["promotion_authority"]),
        evidence_authority=str(capabilities["evidence_authority"]),
        trust_authority=bool(capabilities["trust_authority"]),
        private_secrets=bool(capabilities["private_secrets"]),
