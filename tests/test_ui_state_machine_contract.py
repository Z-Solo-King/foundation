...
def test_ui_contract_covers_required_lifecycle_states():
    ...
    for state in ("NEW_CHAT", "SUBMITTING", "QUEUED", "RUNNING", "STREAMING", "COMPLETE", "PARTIAL", "BLOCKED", "REJECTED", "UNAVAILABLE", "UNKNOWN", "RECONNECTING", "RESUMED", "REPLAYED", "AUTH_EXPIRED"):
