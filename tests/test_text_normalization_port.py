...
def test_identifier_wrappers_and_limits():
    ...
    assert clean_identifier("ab c_d", max_len=4) == "AB_C"
...
def test_identifier_kind_aliases():
    assert normalize_identifier("A1", "sku") == "A1"
    assert normalize_identifier("A1", "variant_sku") == "A1"
    assert normalize_identifier("A1", "product_id") == "A1"
    assert normalize_identifier("A1", "variant_id") == "A1"
