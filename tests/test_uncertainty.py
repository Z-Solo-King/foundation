...
def test_uncertainty_rejects_blank_population_revision():
    with pytest.raises(ValueError, match="population_revision"):
        ClaimUncertainty("c1", UncertaintyState.UNKNOWN, False, True, 0, population_revision=" ").validate()
