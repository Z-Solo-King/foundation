...
CANONICAL_OPERATIONS_REF = "4261b3e18c30b9b8bb83eb25586cd55e45e806a8"
...
def test_production_pin_self_check_matches_canonical_operations_revision():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert "test \"$OPERATIONS_REF\" = '4261b3e18c30b9b8bb83eb25586cd55e45e806a8'" in deployment
...
def test_canonical_operations_pin_matches_latest_migration_head():
    ...
    assert "OPERATIONS_RESEARCH_REF: 4261b3e18c30b9b8bb83eb25586cd55e45e806a8" in nightly
...
def test_runtime_and_nightly_auxiliary_pins_are_not_stale():
    expected_production = "4261b3e18c30b9b8bb83eb25586cd55e45e806a8"
    expected_nightly = "4261b3e18c30b9b8bb83eb25586cd55e45e806a8"
    auxiliary = {
