...
CANONICAL_OPERATIONS_REF = "242deeeab85834d18c4fe0efda7517e924e8ba63"
...
def test_production_pin_self_check_matches_canonical_operations_revision():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert "test \"$OPERATIONS_REF\" = '242deeeab85834d18c4fe0efda7517e924e8ba63'" in deployment
...
def test_canonical_operations_pin_matches_latest_migration_head():
    ...
    assert "OPERATIONS_RESEARCH_REF: 242deeeab85834d18c4fe0efda7517e924e8ba63" in nightly
...
def test_legacy_worker_retirement_handles_reciprocal_service_bindings():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    ...
    assert "force=true" in deployment
...
def test_runtime_and_nightly_auxiliary_pins_are_not_stale():
    expected_production = "242deeeab85834d18c4fe0efda7517e924e8ba63"
    expected_nightly = "242deeeab85834d18c4fe0efda7517e924e8ba63"
    auxiliary = {
