...
CANONICAL_OPERATIONS_REF = "79f5e4e413f663fc2d8484acd090676fbe957625"
...
def test_canonical_operations_pin_matches_latest_migration_head():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert 'OPERATIONS_REF="79f5e4e413f663fc2d8484acd090676fbe957625"' in deployment
    nightly = texts = _workflow_texts()["nightly-multi-agent-research-v2.yml"]
    assert "OPERATIONS_RESEARCH_REF: 79f5e4e413f663fc2d8484acd090676fbe957625" in nightly
