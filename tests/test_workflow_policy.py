...
CANONICAL_OPERATIONS_REF = "cc59662e54b788a98e30b9d5030cf8c0f86e66bf"
...
def test_canonical_operations_pin_matches_latest_migration_head():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert 'OPERATIONS_REF="cc59662e54b788a98e30b9d5030cf8c0f86e66bf"' in deployment
    nightly = texts = _workflow_texts()["nightly-multi-agent-research-v2.yml"]
    assert "OPERATIONS_RESEARCH_REF: cc59662e54b788a98e30b9d5030cf8c0f86e66bf" in nightly
