...
CANONICAL_OPERATIONS_REF = "c0f6d92bf972874ef00480a7ff4272b058f69b1c"
...
def test_production_pin_self_check_matches_canonical_operations_revision():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert "test \"$OPERATIONS_REF\" = 'c0f6d92bf972874ef00480a7ff4272b058f69b1c'" in deployment
...
def test_canonical_operations_pin_matches_latest_migration_head():
    ...
    assert "OPERATIONS_RESEARCH_REF: c0f6d92bf972874ef00480a7ff4272b058f69b1c" in nightly
...
def test_runtime_and_nightly_auxiliary_pins_are_not_stale():
    expected_production = "c0f6d92bf972874ef00480a7ff4272b058f69b1c"
    expected_nightly = "c0f6d92bf972874ef00480a7ff4272b058f69b1c"
    auxiliary = {
