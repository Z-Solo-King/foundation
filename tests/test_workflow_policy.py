...
CANONICAL_OPERATIONS_REF = "327d7548da60de3a3378ea1586df69ae5f3e1d40"
...
def test_production_pin_self_check_matches_canonical_operations_revision():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert "test \"$OPERATIONS_REF\" = '327d7548da60de3a3378ea1586df69ae5f3e1d40'" in deployment
...
def test_canonical_operations_pin_matches_latest_migration_head():
    ...
    assert "OPERATIONS_RESEARCH_REF: 327d7548da60de3a3378ea1586df69ae5f3e1d40" in nightly
...
def test_runtime_and_nightly_auxiliary_pins_are_not_stale():
    expected_production = "327d7548da60de3a3378ea1586df69ae5f3e1d40"
    expected_nightly = "327d7548da60de3a3378ea1586df69ae5f3e1d40"
    auxiliary = {
