...
CANONICAL_OPERATIONS_REF = "0fa576c10fee30221150110865b11c0132de4575"
...
def test_canonical_operations_pin_matches_latest_migration_head():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert 'OPERATIONS_REF="0fa576c10fee30221150110865b11c0132de4575"' in deployment
    nightly = texts = _workflow_texts()["nightly-multi-agent-research-v2.yml"]
    assert "OPERATIONS_RESEARCH_REF: 0fa576c10fee30221150110865b11c0132de4575" in nightly
