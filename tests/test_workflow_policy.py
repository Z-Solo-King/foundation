...
CANONICAL_OPERATIONS_REF = "01db4ef843a0d07b5eab11d2776863abe79301e5"
...
def test_production_pin_self_check_matches_canonical_operations_revision():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert "test \"$OPERATIONS_REF\" = '01db4ef843a0d07b5eab11d2776863abe79301e5'" in deployment
...
def test_canonical_operations_pin_matches_latest_migration_head():
    ...
    assert "OPERATIONS_RESEARCH_REF: 01db4ef843a0d07b5eab11d2776863abe79301e5" in nightly
...
def test_runtime_and_nightly_auxiliary_pins_are_not_stale():
    expected_production = "01db4ef843a0d07b5eab11d2776863abe79301e5"
    expected_nightly = "01db4ef843a0d07b5eab11d2776863abe79301e5"
    auxiliary = {
