...
CANONICAL_OPERATIONS_REF = "4a471024c2885c3167d1ec9b4b3c648b9e324e7e"
...
def test_canonical_operations_pin_matches_latest_migration_head():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert 'OPERATIONS_REF="4a471024c2885c3167d1ec9b4b3c648b9e324e7e"' in deployment
    nightly = texts = _workflow_texts()["nightly-multi-agent-research-v2.yml"]
    assert "OPERATIONS_RESEARCH_REF: 4a471024c2885c3167d1ec9b4b3c648b9e324e7e" in nightly
