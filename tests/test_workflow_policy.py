...
CANONICAL_OPERATIONS_REF = "4692d398a25eff4b5cb73daa562a59d900852525"
...
def test_production_pin_self_check_matches_canonical_operations_revision():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert "test \"$OPERATIONS_REF\" = '4692d398a25eff4b5cb73daa562a59d900852525'" in deployment
...
def test_canonical_operations_pin_matches_latest_migration_head():
    ...
    assert "OPERATIONS_RESEARCH_REF: 4692d398a25eff4b5cb73daa562a59d900852525" in nightly
...
def test_runtime_and_nightly_auxiliary_pins_are_not_stale():
    expected_production = "4692d398a25eff4b5cb73daa562a59d900852525"
    expected_nightly = "4692d398a25eff4b5cb73daa562a59d900852525"
    auxiliary = {
