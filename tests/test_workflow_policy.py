...
CANONICAL_OPERATIONS_REF = "a82e1839bbf1c30c69cc1d50121e33090d06a68c"
...
def test_production_pin_self_check_matches_canonical_operations_revision():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert "test \"$OPERATIONS_REF\" = 'a82e1839bbf1c30c69cc1d50121e33090d06a68c'" in deployment
...
def test_canonical_operations_pin_matches_latest_migration_head():
    ...
    assert "OPERATIONS_RESEARCH_REF: a82e1839bbf1c30c69cc1d50121e33090d06a68c" in nightly
...
def test_runtime_and_nightly_auxiliary_pins_are_not_stale():
    expected_production = "a82e1839bbf1c30c69cc1d50121e33090d06a68c"
    expected_nightly = "a82e1839bbf1c30c69cc1d50121e33090d06a68c"
    auxiliary = {
