...
CANONICAL_OPERATIONS_REF = "122a334d85708e2e42db59b74114d1396ca98f31"
...
def test_production_pin_self_check_matches_canonical_operations_revision():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert "test \"$OPERATIONS_REF\" = '122a334d85708e2e42db59b74114d1396ca98f31'" in deployment
...
def test_canonical_operations_pin_matches_latest_migration_head():
    ...
    assert "OPERATIONS_RESEARCH_REF: 122a334d85708e2e42db59b74114d1396ca98f31" in nightly
...
def test_runtime_and_nightly_auxiliary_pins_are_not_stale():
    expected_production = "122a334d85708e2e42db59b74114d1396ca98f31"
    expected_nightly = "122a334d85708e2e42db59b74114d1396ca98f31"
    auxiliary = {
