...
CANONICAL_OPERATIONS_REF = "a97deac581b797c2de3aaf7638b965d9823faf53"
...
def test_canonical_operations_pin_matches_latest_migration_head():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert 'OPERATIONS_REF="a97deac581b797c2de3aaf7638b965d9823faf53"' in deployment
    nightly = texts = _workflow_texts()["nightly-multi-agent-research-v2.yml"]
    assert "OPERATIONS_RESEARCH_REF: a97deac581b797c2de3aaf7638b965d9823faf53" in nightly
