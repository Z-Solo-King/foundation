...
CANONICAL_OPERATIONS_REF = "f0e01a227066d1c7069eccbbc2eba1c523a8baf7"
...
def test_canonical_operations_pin_matches_latest_migration_head():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert 'OPERATIONS_REF="f0e01a227066d1c7069eccbbc2eba1c523a8baf7"' in deployment
    nightly = texts = _workflow_texts()["nightly-multi-agent-research-v2.yml"]
    assert "OPERATIONS_RESEARCH_REF: f0e01a227066d1c7069eccbbc2eba1c523a8baf7" in nightly
