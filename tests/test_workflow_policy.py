...
CANONICAL_OPERATIONS_REF = "37860fcee213c26fbb4025d7b4829a2b31ef712a"
...
def test_production_pin_self_check_matches_canonical_operations_revision():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert "test \"$OPERATIONS_REF\" = '37860fcee213c26fbb4025d7b4829a2b31ef712a'" in deployment
...
def test_canonical_operations_pin_matches_latest_migration_head():
    ...
    assert "OPERATIONS_RESEARCH_REF: 37860fcee213c26fbb4025d7b4829a2b31ef712a" in nightly
...
def test_runtime_and_nightly_auxiliary_pins_are_not_stale():
    expected_production = "37860fcee213c26fbb4025d7b4829a2b31ef712a"
    expected_nightly = "37860fcee213c26fbb4025d7b4829a2b31ef712a"
    auxiliary = {
