...
CANONICAL_OPERATIONS_REF = "6969d80b28cf8ce3682ad28efea1d3b519518a90"
...
def test_production_pin_self_check_matches_canonical_operations_revision():
    deployment = PRODUCTION_SCRIPT.read_text(encoding="utf-8")
    assert "test \"$OPERATIONS_REF\" = '6969d80b28cf8ce3682ad28efea1d3b519518a90'" in deployment
...
def test_canonical_operations_pin_matches_latest_migration_head():
    ...
    assert "OPERATIONS_RESEARCH_REF: 6969d80b28cf8ce3682ad28efea1d3b519518a90" in nightly
...
def test_runtime_and_nightly_auxiliary_pins_are_not_stale():
    expected_production = "6969d80b28cf8ce3682ad28efea1d3b519518a90"
    expected_nightly = "6969d80b28cf8ce3682ad28efea1d3b519518a90"
    auxiliary = {
