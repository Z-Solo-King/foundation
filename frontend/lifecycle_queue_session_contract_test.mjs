...
const queueControls = fs.readFileSync(new URL('./generated/lifecycle_queue_controls.js', import.meta.url), 'utf8');
...
assert.match(index, /generated\/lifecycle_queue_controls\.js/);
