...
from backend.intelligence.sources import SourcePolicy, Source, evaluate_source
...
def choose_method(source: Source, policy: SourcePolicy):
...
def reserve_acquisition(source: Source, policy: SourcePolicy, budget: ResourceBudget):
