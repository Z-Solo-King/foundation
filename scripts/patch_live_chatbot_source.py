...
if old_line not in text:
    raise SystemExit("Operations deploy line not found")
...
def test_release_materializes_ai_provider_and_private_chat_auth():
...
def test_ui_language_matches_public_chat():
...
def test_public_zero_cost_flag_is_source_declared():
