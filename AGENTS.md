...
Before any new mutation, read `docs/AI_AGENT_HANDOFF.md`. The 2026-09-19 live-state section is authoritative over older sections. Current production-code Foundation main is `b1e0e6e74e0d3d9a3e280fa146a6c39503628274`; the latest main commit `63e45709d24e8acd8ec720036c4c11f0a531f78e` is documentation-only. current Operations main and production pin are `b43c19554100bcdded0c6e70d966b30e5e4df04c`.
