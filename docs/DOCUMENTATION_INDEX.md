...
10. `DEPLOYMENT.md` and `.github/workflows/production-release.yml` — public deployment path.
...
`DEPLOYMENT.md` is the detailed deployment guide. It records the canonical `.github/workflows/production-release.yml` workflow and the evidence rules for distinguishing a deployment attempt from current production verification.
